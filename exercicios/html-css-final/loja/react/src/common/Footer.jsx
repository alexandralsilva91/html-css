        ...
        <div className="footer-full-container">
            <div className="social-media">
                ...
                <div className="social-media-icons">
                    <img className="social-media-icon" src="../../public/icons/whatsapp.svg" alt="whatsapp icon" />
                    <img className="social-media-icon" src="../../public/icons/instagram.svg" alt="instagram icon" />
                    <img className="social-media-icon" src="../../public/icons/facebook.svg" alt="facebook icon" />
                </div>
            </div>
